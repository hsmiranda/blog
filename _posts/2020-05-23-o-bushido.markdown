...
layout: post
comments: true
title: "Bugtraq shutdown"
date:   2021-01-26 17:00:52 -0300
categories: bugtraq mailist shutdown oldscholl
permalink: /posts/bugtraq-shutdown/
---
Hi :) 

É galera shutdown da bugtraq, foi uma grande fonte de informações, aprendi muito com as publicações dela.
...
and learned from each other through these lists.  The history of the list and the
...
something like “So long, and thanks for all the fish”, but that seems too cavalier for 
this. So thank you, for your support, wisdom, and willingness to share – whether
